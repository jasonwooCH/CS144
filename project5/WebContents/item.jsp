...
<html>
	...
	<body onload="initialize()">
		...
		<b>Here is the result for ItemID: <%= request.getAttribute("reqItemID") %></b>
		...
		<ul>
			...
			<li>Buy Price: <%= request.getAttribute("Buy_Price") %></li>
		...
		<!--
		<c:if test="${not empty Buy_Price}">
			<a href="/eBay/pay">Pay Now</a>
		</c:if>
		-->

		<% 
			if (request.getAttribute("Buy_Price") != null && 
					!request.getAttribute("Buy_Price").equals(""))
				out.println("<a href=\"/eBay/pay\">Pay Now</a>");
		%>
